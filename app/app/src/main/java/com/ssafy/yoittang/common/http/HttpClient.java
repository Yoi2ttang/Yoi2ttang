package com.ssafy.yoittang.common.http;
...
//            conn.setRequestProperty("Cookie", cookies);
    ...
    public ResponseWrapper sentToServerWithAccessToken(
            String method,
            String detailUrl,
            Map<?, ?> jsonAppendMap) {
        ...
        try {
            ...
            if (cookies == null || !cookies.contains("accessToken=")) {
                return new ResponseWrapper(401, null);
            }
            ...
            Log.d("AuthHeader", "Bearer " + accessToken);
